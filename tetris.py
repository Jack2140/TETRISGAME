...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.596, WIN_H * 0.02),
                            text='TETRIS', fgcolor=self.get_color(),
                            size=TILE_SIZE * 1.3, bgcolor='blue')
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.22),
                            text='next', fgcolor='orange',
                            size=TILE_SIZE * 1.4, bgcolor='blue')
...
class Tetris:
    def __init__(self, app):
        ...
        self.score = 0
        self.full_lines = 0
        self.points_per_lines = {0: 0, 1: 150, 2: 400, 3: 900, 4: 2000}
    ...
    def check_teromino_land(self):
        if self.tetromino.land:
